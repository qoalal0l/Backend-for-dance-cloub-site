...
@WebServlet("/admin/UpdateInstructorSmallImage")
public class UpdateInstructorSmallImage extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			newImagePath = IMAGE_STORAGE + INSTRUCTOR_SMALL + image.getName();
			oldImagePath = IMAGE_STORAGE + INSTRUCTOR_SMALL + instructor.getSmallImg();
			...
			instructorManager.updateInstructorSmallImage(instructorId,
					new Instructor(-1, null, null, null, newImageFile.getName(), null, null, -1, Timestamper.now(), adminId));
